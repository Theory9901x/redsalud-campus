    ...
    questions: [
      {
        ...
        config: {
          ...
          autoAvanzar: true,
          opciones: [
            { id: "si", texto: "Sí", tono: "exc" },
            { id: "no", texto: "No", tono: "muymal" },
          ],
        },
      },
    ],
    ...
    questions: [
      {
        ...
        config: {
          ...
          autoAvanzar: true,
          opciones: [
            { id: "si-respeto", texto: "Siempre fue respetuoso y amable.", tono: "exc" },
            { id: "inconveniente", texto: "En algunas ocasiones tuve dificultades o inconvenientes en el trato con el personal.", tono: "reg" },
            { id: "sin-normas", texto: "No conocía las normas de convivencia y trato establecidas por la institución.", tono: "mal" },
          ],
        },
      },
    ],
