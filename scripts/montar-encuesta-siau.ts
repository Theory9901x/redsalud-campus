...
const BLOQUES: Bloque[] = [
    ...
    questions: [
      {
        ...
        config: {
          ...
          opciones: [
            ...
            // "No responde" no es una calificación: no se mide (igual que "No aplica").
    ...
    questions: [
      {
        ...
        config: {
          ...
          autoAvanzar: true,
          opciones: [
            // Orden literal del formato. Favorable = las dos respuestas de "Sí".
            { id: "definitivamente-si", texto: "Definitivamente Sí", tono: "exc" },
            { id: "probablemente-si", texto: "Probablemente Sí", tono: "bue" },
            { id: "definitivamente-no", texto: "Definitivamente No", tono: "muymal" },
            { id: "probablemente-no", texto: "Probablemente No", tono: "mal" },
            { id: "no-responde", texto: "No responde", tono: "na" },
          ],
        },
      },
    ...
    questions: [
      {
        ...
        config: {
          ...
          autoAvanzar: true,
          opciones: [
            { id: "si-siempre", texto: "Sí, siempre me informaron con claridad.", tono: "exc" },
            { id: "si-mayoria", texto: "Sí, la mayoría de veces, aunque me quedaron algunas dudas.", tono: "bue" },
            { id: "no-mayoria", texto: "No, la mayoría de las veces la información no fue clara.", tono: "reg" },
            { id: "no-nunca", texto: "No, nunca me dieron información clara sobre mi estado.", tono: "mal" },
          ],
        },
      },
    ],
  },
  {
    ...
    questions: [
      {
        type: "SINGLE_CHOICE",
        prompt: "8: Durante su permanencia en la institución, ¿cómo considera que fue su trato hacia el personal de la IPS?",
        isRequired: true,
        config: {
          estilo: "semaforo",
          autoAvanzar: true,
          opciones: [
            { id: "siempre-respetuoso", texto: "Sí, siempre mantuve un trato respetuoso.", tono: "exc" },
            { id: "casi-siempre", texto: "Casi siempre respetuoso, la relación fue cordial.", tono: "bue" },
            { id: "inconveniente", texto: "Tuve algún inconveniente en el trato con el personal.", tono: "reg" },
            { id: "actitud-dificil", texto: "Mi actitud fue difícil, sentí que no me atendían bien.", tono: "mal" },
          ],
        },
      },
    ],
