/**
 * animation-timeline: view()/scroll() en CSS puro (sin JS). Se sirve como
 * <style> literal, sin pasar por Tailwind/Lightning CSS: ese pipeline
 * descarta en silencio esta sintaxis (aún no la reconoce) junto con
 * cualquier @keyframes asociado, así que la única forma de que llegue
 * intacta al navegador es esta.
 *
...
export function ScrollDrivenStyles() {
