...
function TableHead({ className, ...props }: React.ComponentProps<"th">) {
  return (
    <th
      ...
      className={cn(
        "h-11 px-2 text-left align-middle text-[11px] font-semibold tracking-wide whitespace-nowrap text-slate-600 uppercase [&:has([role=checkbox])]:pr-0 dark:text-slate-300",
        className
      )}
      {...props}
    />
